...
router.get('/view/:id', (req, res) => {
  ...
  var sql =
    'SELECT * FROM questions INNER JOIN profile on questions.p_id=profile.p_id  WHERE questions.q_id=? ; SELECT * FROM answers INNER JOIN questions on answers.q_id=questions.q_id INNER JOIN profile on profile.p_id=questions.p_id WHERE answers.authenticate=1 AND answers.q_id=?  ';
